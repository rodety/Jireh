...
object_Luna::object_Luna(_QSTR Producto_idProducto, _QSTR Diametro_idDiametro, _QSTR CalidadLuna_idCalidadLuna, _QSTR TipoLuna_idTipoLuna, _QSTR Tratamiento_idTratamiento, _QSTR valorInicial, _QSTR valorFinal, _QSTR precio, _QSTR cilindro, _QSTR cilindrof, _QSTR Lista_idLista, _QSTR Laboratorio_idLaboratorio)
{
	//file Luna
	...
	md_o_CalidadLuna_idCalidadLuna = CalidadLuna_idCalidadLuna;
	...
	md_o_Lista_idLista = Lista_idLista;
	md_o_Laboratorio_idLaboratorio = Laboratorio_idLaboratorio;
}
object_Luna::object_Luna(_QSTR Diametro_idDiametro, _QSTR CalidadLuna_idCalidadLuna, _QSTR TipoLuna_idTipoLuna, _QSTR Tratamiento_idTratamiento, _QSTR valorInicial, _QSTR valorFinal, _QSTR precio, _QSTR cilindro, _QSTR cilindrof, _QSTR Lista_idLista, _QSTR Laboratorio_idLaboratorio)
{
	//file Luna
...
void object_Luna::mf_set_CalidadLuna_idCalidadLuna(_QSTR CalidadLuna_idCalidadLuna)
{
	//function mf_set_CalidadLuna_idCalidadLuna
	//w!
...
{
	//function mf_set_cilindrof
	//w!

	md_o_cilindrof = cilindrof;
}
void object_Luna::mf_set_Lista_idLista(_QSTR Lista_idLista)
{
	//function mf_set_Lista_idLista
	//w!

	md_o_Lista_idLista = Lista_idLista;
}
void object_Luna::mf_set_Laboratorio_idLaboratorio(_QSTR Laboratorio_idLaboratorio)
{
	//function mf_set_Laboratorio_idLaboratorio
	//w!
...
_QSTR object_Luna::mf_get_CalidadLuna_idCalidadLuna()
{
	//function mf_get_CalidadLuna_idCalidadLuna
	//w!

	return md_o_CalidadLuna_idCalidadLuna;
}
...
{
	//function mf_get_cilindrof
	//w!

	return md_o_cilindrof;
}
_QSTR object_Luna::mf_get_Lista_idLista()
{
	//function mf_get_Lista_idLista
	//w!

	return md_o_Lista_idLista;
}
_QSTR object_Luna::mf_get_Laboratorio_idLaboratorio()
{
	//function mf_get_Laboratorio_idLaboratorio
	//w!

	return md_o_Laboratorio_idLaboratorio;
}
...
bool object_Luna::mf_load(_QSTR pk)
{
	...
	if(query.next())
	{
		...
		md_o_CalidadLuna_idCalidadLuna = query.value(2).toString();
		...
		md_o_Lista_idLista = query.value(10).toString();
		md_o_Laboratorio_idLaboratorio = query.value(11).toString();
...
bool object_Luna::mf_add()
{
	...
	str_query += ", CalidadLuna_idCalidadLuna";
	...
	str_query += ", cilindro";
	str_query += ", cilindrof";
	str_query += ", Lista_idLista";
	str_query += ", Laboratorio_idLaboratorio";
	str_query += ") VALUES(";
	str_query += "?";
	str_query += ", ?";
	str_query += ", ?";
	...
	query.bindValue(integer++, md_o_CalidadLuna_idCalidadLuna);
	...
	query.bindValue(integer++, md_o_Lista_idLista);
	query.bindValue(integer++, md_o_Laboratorio_idLaboratorio);
...
bool object_Luna::mf_update()
{
	...
	query.prepare("UPDATE Luna SET Diametro_idDiametro = ?, CalidadLuna_idCalidadLuna = ?, TipoLuna_idTipoLuna = ?, Tratamiento_idTratamiento = ?, valorInicial = ?, valorFinal = ?, precio = ?, cilindro = ?, cilindrof = ?, Lista_idLista = ?, Laboratorio_idLaboratorio = ? WHERE Producto_idProducto = ?");
	query.bindValue(0, md_o_Diametro_idDiametro);
	query.bindValue(1, md_o_CalidadLuna_idCalidadLuna);
	...
	query.bindValue(9, md_o_Lista_idLista);
	query.bindValue(10, md_o_Laboratorio_idLaboratorio);
	query.bindValue(11, md_o_Producto_idProducto);
