...
public:
    ...
    virtual bool evaluate( QString& exp, ExpType, NCReportSection* section=0 );
    ...
    virtual bool evaluateDynamicText( NCReportItem*, QString* target=0 );
    virtual bool evaluateDynamicImage( NCReportItem* );
    virtual bool evaluateDynamicGraph( NCReportItem* );
    virtual bool evaluateDynamicBarcode( NCReportItem* );
