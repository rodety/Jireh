...
public:
    ...
    virtual bool update( const QVariant& foreignKeyValue );
    ...
    virtual QVariant getUserFunctionValue( const QString& arguments ) const;
...
signals:
    void updateRequest( const QString& dsID, const QVariant& foreignKeyValue );
