...
void UsuariosForm::configListTab()
{
    ...
    relTableModel->setHeaderData(1,Qt::Horizontal,"primer_apellido");
    relTableModel->setHeaderData(2,Qt::Horizontal,"segundo_apellido");
    ...
    relTableModel->setHeaderData(4,Qt::Horizontal,"usuario");
    ...
    relTableModel->setHeaderData(6,Qt::Horizontal,"Documento_idDocumento");
    relTableModel->setHeaderData(7,Qt::Horizontal,"numeroDocumento");
    relTableModel->setHeaderData(8,Qt::Horizontal,"direccion");
    relTableModel->setRelation(9,QSqlRelation("SiNo","idSiNo","sexo"));
    relTableModel->setHeaderData(9,Qt::Horizontal,"sexo");
    relTableModel->setHeaderData(10,Qt::Horizontal,"fechaNacimiento");
    //relTableModel->setHeaderData(11,Qt::Horizontal,"Nacionalidad");
    relTableModel->setHeaderData(11,Qt::Horizontal,"telefono");
    relTableModel->setHeaderData(12,Qt::Horizontal,"email");
    relTableModel->setHeaderData(13,Qt::Horizontal,"telefono2");
    relTableModel->setHeaderData(14,Qt::Horizontal,"telefono2");
    relTableModel->setRelation(15,QSqlRelation("SiNo","idSiNo","value"));
    relTableModel->setHeaderData(15,Qt::Horizontal,"resset_pass");
...
void UsuariosForm::configPermisosModelView()
{
    ...
    permisosModel->setHeaderData(3,Qt::Horizontal,"habilitado");
